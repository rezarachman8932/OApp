...
class ConnectedUsersAdapter(var context: Context) : RecyclerView.Adapter<ConnectedUsersAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): ViewHolder {
        val item = LayoutInflater.from(parent.context).inflate(R.layout.item_list_connected_users, parent, false) as RelativeLayout
    ...
    class ViewHolder(override val containerView: View) : RecyclerView.ViewHolder(containerView), LayoutContainer {
        fun bindItem(context: Context, userConnected: UserConnected, listener: (UserConnected) -> Unit) {
            ...
            OAppImageUtil.setImage("http://api.ademuhammad.or.id/uploads/post/sunday-sale201812220713180.JPG", R.drawable.ic_logo, item_image_connected_user)
